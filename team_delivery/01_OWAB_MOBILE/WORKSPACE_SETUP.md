...
## الهيكل المعتمد لمساحة عمل المطور: أواب النزيلي

---

## الهيكل النموذجي لمجلد العمل:
```text
01_OWAB_MOBILE_WORKSPACE/
...
│   └── prompts/shared/
│
├── mobile_app/               # (مساحة التطوير البرمجية الفعلية المسموح بالتعديل فيها)
│   ├── lib/
│   └── test/
│
...
1. افتح مجلد مساحة عملك الكاملة (`01_OWAB_MOBILE_WORKSPACE/`) في Antigravity IDE.
2. تأكد من أن الـ IDE يستطيع قراءة مجلد `team_package/` كمرجع مرئي.
3. تأكد أن التعديلات البرمجية تُنشأ حصرياً داخل `mobile_app/`.
