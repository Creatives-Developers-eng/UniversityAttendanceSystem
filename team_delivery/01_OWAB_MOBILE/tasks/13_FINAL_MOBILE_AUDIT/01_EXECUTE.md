...
## المهمة: التدقيق المعماري الشامل لتطبيق الهاتف (Mobile Architecture Audit)
...
- المهمة الحالية: التدقيق المعماري الشامل لتطبيق الهاتف (Mobile Architecture Audit)
- الهدف الأساسي: فحص نظافة الطبقات وخلو الكود من التبعيات غير المصرح بها والتأكد من عزل المجلدات
...
==================================================
- إجراء تحليل ساكن للكود، إزالة التبعيات الزائدة، والتحقق من تغطية الاختبارات
- البنية المطلوبة للملفات: mobile_app/ (Full app structure)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: flutter analyze, dart analyze
- مبرر اختيار التقنيات: تسليم كود عالي الجودة ومعتمد بنسبة 100%
- قواعد التسميات المعتمدة: MobileArchitectureAuditReport
