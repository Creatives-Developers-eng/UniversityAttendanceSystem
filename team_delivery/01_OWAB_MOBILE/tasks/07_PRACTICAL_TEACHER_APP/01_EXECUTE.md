...
## المهمة: بناء واجهات الأستاذ العملي (Practical Teacher UI)
...
- المهمة الحالية: بناء واجهات الأستاذ العملي (Practical Teacher UI)
- الهدف الأساسي: بناء واجهات أستاذ المعمل العملي لاستعراض الشعب وإدارة الجلسات والتحضير اليدوي
...
==================================================
- بناء شاشات استعراض مجموعات المعامل، متابعة الحضور العملي، واعتماد الاستثناءات
- البنية المطلوبة للملفات: mobile_app/lib/practical_teacher/ (practical_dashboard_view.dart, lab_groups_view.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Flutter Data Tables & Action Modals
- مبرر اختيار التقنيات: تمكين أستاذ العملي من إدارة مجموعات المعمل والتحضير المرن
- قواعد التسميات المعتمدة: PracticalDashboardView, LabAttendanceView
