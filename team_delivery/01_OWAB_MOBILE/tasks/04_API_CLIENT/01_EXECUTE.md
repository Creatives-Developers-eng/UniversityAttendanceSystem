...
## المهمة: بناء عميل REST API والـ Interceptors (API Client & Auth Interceptors)
...
- المهمة الحالية: بناء عميل REST API والـ Interceptors (API Client & Auth Interceptors)
- الهدف الأساسي: إنشاء عميل HTTP موحد مع دعم إعادة التوكن التلقائي ومعالجة الأخطاء المعيارية
...
==================================================
- بناء فئة ApiClient وتضمين توكن Bearer في الترويسات والتعامل مع أخطاء 401 و 403 و 500
- البنية المطلوبة للملفات: mobile_app/lib/core/network/ (api_client.dart, auth_interceptor.dart, api_error.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Dio, Interceptors, PrettyDioLogger
- مبرر اختيار التقنيات: إدارة متقدمة للطلبات والـ Retry التلقائي عند تجديد التوكن
- قواعد التسميات المعتمدة: ApiClient, AuthInterceptor, NetworkException
