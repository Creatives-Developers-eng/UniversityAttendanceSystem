...
## المهمة: تأسيس طبقة التخزين المحلي الآمن (Local & Secure Storage)
...
- المهمة الحالية: تأسيس طبقة التخزين المحلي الآمن (Local & Secure Storage)
- الهدف الأساسي: تشفير وحفظ توكنات المصادقة وبيانات الجهاز وحالة الحساب محلياً
...
==================================================
- بناء واجهة وتطبيق التخزين الآمن وحفظ الـ Access Token والـ Refresh Token ومعرف الجهاز
- البنية المطلوبة للملفات: mobile_app/lib/core/storage/ (secure_storage_service.dart, local_preferences.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: flutter_secure_storage, shared_preferences
- مبرر اختيار التقنيات: توفير تشفير على مستوى نظام التشغيل (KeyStore على Android و Keychain على iOS)
- قواعد التسميات المعتمدة: SecureStorageService, StorageKeys
