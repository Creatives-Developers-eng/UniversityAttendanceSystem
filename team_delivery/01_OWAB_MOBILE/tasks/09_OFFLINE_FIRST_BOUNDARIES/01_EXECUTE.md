...
## المهمة: بناء حدود العمل دون اتصال (Offline-First Boundaries & Local Cache)
...
- المهمة الحالية: بناء حدود العمل دون اتصال (Offline-First Boundaries & Local Cache)
- الهدف الأساسي: تخزين بيانات المقررات والشعب والملف الشخصي محلياً للعمل عند انقطاع الإنترنت
...
==================================================
- تأسيس طبقة التخزين المؤقت وفحص حالة الاتصال بالإنترنت والتبديل للبيانات المحلية
- البنية المطلوبة للملفات: mobile_app/lib/core/offline/ (offline_cache_manager.dart, connectivity_service.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Hive/Isar/Sqflite, ConnectivityPlus
- مبرر اختيار التقنيات: استمرار تشغيل التطبيق في القاعات والمعامل المعزولة عن التغطية
- قواعد التسميات المعتمدة: OfflineCacheManager, CachePolicy
