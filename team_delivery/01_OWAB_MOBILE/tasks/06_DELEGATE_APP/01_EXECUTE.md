...
## المهمة: بناء واجهات المندوب وهيكل الجلسة (Delegate UI & Session Shell)
...
- المهمة الحالية: بناء واجهات المندوب وهيكل الجلسة (Delegate UI & Session Shell)
- الهدف الأساسي: بناء واجهات المندوب لإدارة وبدء واستعراض جلسات الحضور الحية وكشوفات الطلاب
...
==================================================
- بناء شاشات: لوحة تحكم المندوب، زر بدء الجلسة، واجهة عرض الطلاب الحاضرين فورياً
- البنية المطلوبة للملفات: mobile_app/lib/delegate/ (delegate_dashboard_view.dart, live_session_view.dart, delegate_attendance_sheet.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Flutter State Management, Animated Lists
- مبرر اختيار التقنيات: متابعة لحظية ومريحة لعملية التحضير بالقاعة بدون تعقيد
- قواعد التسميات المعتمدة: DelegateDashboardView, LiveSessionView
