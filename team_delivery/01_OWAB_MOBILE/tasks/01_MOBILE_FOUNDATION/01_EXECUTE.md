...
## المهمة: تأسيس بنية وهيكل تطبيق الهاتف والثيمات (Mobile Foundation & Theming)
...
- المهمة الحالية: تأسيس بنية وهيكل تطبيق الهاتف والثيمات (Mobile Foundation & Theming)
- الهدف الأساسي: بناء الهيكل العام لتطبيق Flutter مع نظام الثيمات الموحد ودعم Material 3 و RTL والرموز اللونية
...
==================================================
- إنشاء ملفات main.dart و app.dart وإعداد ThemeData للوضعين الفاتح والداكن وتوفير ألوان وخطوط UI_UX_SYSTEM.md
- البنية المطلوبة للملفات: mobile_app/lib/app/ (app.dart, routes.dart, theme.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Flutter, Dart, Material 3, Google Fonts (Cairo/Tajawal/Inter)
- مبرر اختيار التقنيات: ضمان توافق الواجهات مع معايير الأداء 60fps ودعم متكامل للعربية RTL
- قواعد التسميات المعتمدة: CamelCase للملفات والـ Widgets، snake_case لأسماء الملفات
