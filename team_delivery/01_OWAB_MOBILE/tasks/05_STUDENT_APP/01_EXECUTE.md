...
## المهمة: بناء واجهات الطالب الشاملة (Student UI Dashboard, Courses, History, Profile)
...
- المهمة الحالية: بناء واجهات الطالب الشاملة (Student UI Dashboard, Courses, History, Profile)
- الهدف الأساسي: إنشاء لوحة تحكم الطالب واستعراض المواد المسجلة والشعب وسجلات الحضور والغياب
...
==================================================
- بناء شاشات: الرئيسية، تفاصيل المقرر، سجل الحضور، البطاقة الجامعية، وتوفير الحالات الخمس
- البنية المطلوبة للملفات: mobile_app/lib/student/ (student_dashboard_view.dart, courses_view.dart, attendance_history_view.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Flutter Widgets, Custom Cards, Shimmer Loading, Responsive Layouts
- مبرر اختيار التقنيات: توفير تجربة مستخدم سلسة واستعراض دقيق لنسب الحضور والغياب مع دعم RTL
- قواعد التسميات المعتمدة: StudentDashboardView, AttendanceHistoryCard
