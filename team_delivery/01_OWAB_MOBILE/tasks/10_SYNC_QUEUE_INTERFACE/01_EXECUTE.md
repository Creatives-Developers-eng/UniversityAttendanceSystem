...
## المهمة: بناء واجهة طابور المزامنة (Sync Queue Interface Boundary)
...
- المهمة الحالية: بناء واجهة طابور المزامنة (Sync Queue Interface Boundary)
- الهدف الأساسي: تجهيز واجهة إرسال دفعات الحضور للمزامنة المركزية مع خادم Backend
...
==================================================
- بناء واجهة ISyncQueue وتحديد عقود الحزم وتجهيز البيانات للإرسال فور عودة الإنترنت
- البنية المطلوبة للملفات: mobile_app/lib/core/sync/ (sync_queue_interface.dart, sync_payload_dto.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Dart Abstract Interfaces & DTOs
- مبرر اختيار التقنيات: عزل منطق واجهات التطبيق عن تفاصيل بروتوكول المزامنة المركزي
- قواعد التسميات المعتمدة: ISyncQueue, SyncPayloadDto, SyncStatus
