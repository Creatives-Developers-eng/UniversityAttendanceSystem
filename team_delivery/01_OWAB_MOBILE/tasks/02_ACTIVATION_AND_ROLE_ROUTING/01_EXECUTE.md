...
## المهمة: مسار التفعيل والتوجيه بحسب الدور (Activation & Role Routing)
...
- المهمة الحالية: مسار التفعيل والتوجيه بحسب الدور (Activation & Role Routing)
- الهدف الأساسي: بناء شاشات تدفق التفعيل برمز الجهاز والتوجيه للدور المناسب (STUDENT, DELEGATE, TEACHER)
...
==================================================
- بناء واجهات إدخال رمز التفعيل، التحقق من حالة الجهاز، وحراسة المسارات بناءً على الـ Role
- البنية المطلوبة للملفات: mobile_app/lib/authentication/ (activation_view.dart, role_guard.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Flutter Routing, State Management (Riverpod/Bloc/Provider)
- مبرر اختيار التقنيات: حماية مسارات التطبيق ومنع وصول المستخدم لغير صلاحياته المعتمدة
- قواعد التسميات المعتمدة: ActivationState, RoleGuard, DeviceActivationDto
