# دليل التشغيل والتسليم الرسمي الشامل | محمد العيدروس (03_MOHAMMED_ALAYDAROUS_LOCAL)
...
2. مجلد حقيبة التسليم والتشغيل الخاصة بك: `team_delivery/03_MOHAMMED_ALAYDAROUS_LOCAL/`.
3. مجلد العمل المسموح لك بالتطوير فيه: `mobile_app/lib/local_server/`.
...
- **المجلد المصرح لك بالتعديل فيه:** `mobile_app/lib/local_server/`
