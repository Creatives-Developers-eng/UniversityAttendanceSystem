...
## المهمة: بناء بروتوكول الاستكشاف المحلي (Local Discovery Protocol)
...
- المهمة الحالية: بناء بروتوكول الاستكشاف المحلي (Local Discovery Protocol)
- الهدف الأساسي: إتاحة استكشاف خادم المندوب تلقائياً لهواتف الطلاب عبر الشبكة المحلية (UDP Broadcast / mDNS)
...
==================================================
- بناء فئتي DiscoveryBroadcaster (للمندوب) و DiscoveryClient (للطالب)
- البنية المطلوبة للملفات: mobile_app/lib/local_network/discovery/ (discovery_broadcaster.dart, discovery_client.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: RawDatagramSocket (UDP Multicast / Broadcast)
- مبرر اختيار التقنيات: تمكين هاتف الطالب من العثور على خادم المندوب تلقائياً دون إدخال IP يدوياً
- قواعد التسميات المعتمدة: DiscoveryBroadcaster, DiscoveryClient, ServiceBeacon
