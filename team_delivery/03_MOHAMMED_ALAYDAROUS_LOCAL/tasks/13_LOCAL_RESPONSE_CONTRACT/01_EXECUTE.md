...
## المهمة: ضبط عقود الاستجابة المحلية (Standard Local Response Contract)
...
- المهمة الحالية: ضبط عقود الاستجابة المحلية (Standard Local Response Contract)
- الهدف الأساسي: إرجاع استجابات معيارية واضحة وموحدة للطالب (ACCEPTED, REJECTED, DUPLICATE, SESSION_EXPIRED)
...
==================================================
- بناء كائنات الاستجابة القياسية LocalAttendanceResponse وتوحيد رموز الأخطاء
- البنية المطلوبة للملفات: mobile_app/lib/local_server/models/ (local_attendance_response.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Standardized JSON DTOs
- مبرر اختيار التقنيات: تمكين هاتف الطالب من فهم النتيجة وعرضها بشكل واضح وفوري
- قواعد التسميات المعتمدة: LocalAttendanceResponse, ResponseStatus
