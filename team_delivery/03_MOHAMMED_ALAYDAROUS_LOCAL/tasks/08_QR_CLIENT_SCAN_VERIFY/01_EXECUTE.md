...
## المهمة: مسح وفحص صلاحية رمز QR (QR Client Scan & Validation)
...
- المهمة الحالية: مسح وفحص صلاحية رمز QR (QR Client Scan & Validation)
- الهدف الأساسي: فك تشفير حمولة الـ QR في هاتف الطالب والتحقق من صلاحيتها الزمنية وتوقيعها والـ Nonce
...
==================================================
- بناء فئة QrPayloadValidator والتحقق من أن الرمز ملتقط في نافذته الزمنية الصالحة
- البنية المطلوبة للملفات: mobile_app/lib/qr_session/scanner/ (qr_payload_validator.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Payload Parsing, Time-Window Tolerance Math
- مبرر اختيار التقنيات: رفض أي رمز قديم أو مزور فورياً على جهاز الطالب قبل محاولة الإرسال
- قواعد التسميات المعتمدة: QrPayloadValidator, QrValidationResult
