...
## المهمة: بناء الخادم المحلي المدمج (Embedded HTTP Server)
...
- المهمة الحالية: بناء الخادم المحلي المدمج (Embedded HTTP Server)
- الهدف الأساسي: تشغيل خادم HTTP محلي مدمج وخفيف على هاتف المندوب لاستقبال طلبات الحضور محلياً
...
==================================================
- بناء فئة LocalHttpServer واستقبال طلبات POST /attendance ومعالجة طلبات Health Check
- البنية المطلوبة للملفات: mobile_app/lib/local_server/server/ (local_http_server.dart, http_router.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: HttpServer (dart:io), Shelf / Lightweight Router
- مبرر اختيار التقنيات: استضافة جلسة الحضور محلياً داخل القاعة بدون الحاجة لإنترنت أو خادم خارجي
- قواعد التسميات المعتمدة: LocalHttpServer, HttpRouter
