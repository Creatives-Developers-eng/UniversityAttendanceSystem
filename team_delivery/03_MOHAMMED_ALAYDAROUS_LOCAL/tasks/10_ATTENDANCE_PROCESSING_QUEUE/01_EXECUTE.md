...
## المهمة: بناء طابور معالجة الحضور المحلي (Attendance Processing Queue & Worker)
...
- المهمة الحالية: بناء طابور معالجة الحضور المحلي (Attendance Processing Queue & Worker)
- الهدف الأساسي: استقبال وتخزين طلبات الحضور في طابور محلي ومعالجتها بالترتيب عبر Worker معزول
...
==================================================
- بناء فئة AttendanceQueue مع طابور FIFO وإسناد المعالجة لعامل خلفي مستقل
- البنية المطلوبة للملفات: mobile_app/lib/attendance_queue/ (attendance_queue.dart, queue_worker.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: In-Memory FIFO Queue, StreamController, Worker Isolation
- مبرر اختيار التقنيات: منع سقوط الخادم عند تدفق عشرات الطلبات المتزامنة في نفس اللحظة
- قواعد التسميات المعتمدة: AttendanceQueue, QueueWorker, QueueItem
