...
## المهمة: توليد رمز QR الديناميكي مع Nonce وطابع زمني (Dynamic QR Generator)
...
- المهمة الحالية: توليد رمز QR الديناميكي مع Nonce وطابع زمني (Dynamic QR Generator)
- الهدف الأساسي: توليد رمز QR متغير دورياً (كل 5-10 ثوانٍ) يحتوي على SessionId و Nonce وطابع زمني وتوقيع HMAC
...
==================================================
- بناء فئة DynamicQrGenerator وتحديث الحمولة المشفرة دورياً عبر Stream
- البنية المطلوبة للملفات: mobile_app/lib/qr_session/generator/ (dynamic_qr_generator.dart, qr_payload.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: HMAC-SHA256, QrImageView / QR Matrix Math, Periodic Timer
- مبرر اختيار التقنيات: منع تصوير الشاشة وتمرير الرمز للزملاء الغائبين (Anti-Replay Attack)
- قواعد التسميات المعتمدة: DynamicQrGenerator, QrPayload
