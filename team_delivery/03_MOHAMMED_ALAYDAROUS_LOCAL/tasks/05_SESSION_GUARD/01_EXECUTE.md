...
## المهمة: بناء حماية وحراسة الجلسة (Session Guard & Access Validator)
...
- المهمة الحالية: بناء حماية وحراسة الجلسة (Session Guard & Access Validator)
- الهدف الأساسي: منع ورفض أي طلبات حضور ترد بعد إغلاق أو إيقاف الجلسة أو قبل انطلاقها رسمياً
...
==================================================
- بناء فئة SessionGuard كحارس يقطع مسار الطلب فورياً في حال عدم صلاحية الجلسة
- البنية المطلوبة للملفات: mobile_app/lib/qr_session/guard/ (session_guard.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Guard Pattern, Middleware Interceptors
- مبرر اختيار التقنيات: حماية أمنية حاسمة تمنع قبول أي طلب متأخر أو غير متزامن مع المحاضرة
- قواعد التسميات المعتمدة: SessionGuard, SessionExpiredException
