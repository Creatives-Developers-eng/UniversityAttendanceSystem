...
## المهمة: بناء عميل الطالب للاتصال المحلي (Student Local HTTP Client)
...
- المهمة الحالية: بناء عميل الطالب للاتصال المحلي (Student Local HTTP Client)
- الهدف الأساسي: إرسال طلب الحضور (AttendanceRequest) من هاتف الطالب إلى الخادم المحلي بهاتف المندوب
...
==================================================
- بناء فئة StudentLocalHttpClient مع معالجة الـ Timeout وضبط مهلة الانتظار بدقة
- البنية المطلوبة للملفات: mobile_app/lib/local_server/client/ (student_local_http_client.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: HttpClient / Dio with short timeouts
- مبرر اختيار التقنيات: اتصال مباشر وسريع جداً عبر الشبكة المحلية مع استجابة فورية للطالب
- قواعد التسميات المعتمدة: StudentLocalHttpClient, LocalAttendanceRequest
