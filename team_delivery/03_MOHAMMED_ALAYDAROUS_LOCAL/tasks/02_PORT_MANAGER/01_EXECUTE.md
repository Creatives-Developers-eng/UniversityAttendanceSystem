...
## المهمة: إدارة وحجز المنافذ المحلية (Local Port Manager)
...
- المهمة الحالية: إدارة وحجز المنافذ المحلية (Local Port Manager)
- الهدف الأساسي: إدارة حجز المنفذ المحلي بأمان (مثل 8080 أو البحث عن منفذ شاغر) وتجنب التعارض
...
==================================================
- بناء فئة PortManager مع آلية فحص الشواغر وحجز المنافذ البديلة تلقائياً
- البنية المطلوبة للملفات: mobile_app/lib/local_server/port/ (port_manager.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: ServerSocket Binding Probe
- مبرر اختيار التقنيات: ضمان إمكانية تشغيل الخادم حتى لو كان هناك منفذ محجوز مسبقاً
- قواعد التسميات المعتمدة: PortManager, PortAllocationException
