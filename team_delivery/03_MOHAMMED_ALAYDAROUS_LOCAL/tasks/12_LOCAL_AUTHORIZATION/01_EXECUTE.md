...
## المهمة: التحقق والتخويل المحلي للطلبات (Local Request Authorization)
...
- المهمة الحالية: التحقق والتخويل المحلي للطلبات (Local Request Authorization)
- الهدف الأساسي: التحقق من توقيع الطلب ومطابقة معرف الجهاز المسجل محلياً للطالب
...
==================================================
- بناء فئة LocalRequestAuthorizer والتحقق من صحة الترويسات والبيانات الأمنية
- البنية المطلوبة للملفات: mobile_app/lib/local_server/auth/ (local_request_authorizer.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Cryptographic Signature Verification
- مبرر اختيار التقنيات: منع إرسال طلبات من أجهزة غير مفعلة أو غير مصرح بها للجلسة
- قواعد التسميات المعتمدة: LocalRequestAuthorizer, AuthResult
