...
## المهمة: إدارة الشبكة المحلية واستخراج IP (Local Network Manager)
...
- المهمة الحالية: إدارة الشبكة المحلية واستخراج IP (Local Network Manager)
- الهدف الأساسي: اكتشاف وتحديد عنوان IP المحلي للهاتف ونقطة الاتصال Hotspot / Wi-Fi وتحديد واجهات الشبكة
...
==================================================
- بناء فئة NetworkManager واستخراج IP المحلي والـ Subnet والتحقق من جاهزية الشبكة
- البنية المطلوبة للملفات: mobile_app/lib/local_network/ (network_manager.dart, network_interface_info.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: NetworkInterface, InternetAddress (dart:io)
- مبرر اختيار التقنيات: معرفة عنوان IP الموثوق بهاتف المندوب لبدء الخادم وبثه للطلاب
- قواعد التسميات المعتمدة: NetworkManager, NetworkInterfaceInfo
