...
## المهمة: بناء لوحة الإحصائيات الرئيسية (Admin Dashboard & Overview Metrics)
...
- المهمة الحالية: بناء لوحة الإحصائيات الرئيسية (Admin Dashboard & Overview Metrics)
- الهدف الأساسي: عرض بطاقات المؤشرات العامة (إجمالي الطلاب، المقررات، الأساتذة، الجلسات النشطة، نسب الحضور)
...
==================================================
- بناء شاشة الـ Dashboard واستدعاء إحصائيات النظام وعرض المخططات والبطاقات المتجاوبة
- البنية المطلوبة للملفات: admin_web/lib/features/dashboard/ (dashboard_view.dart, metric_card.dart, charts_widget.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: fl_chart, Metric Cards Grid
- مبرر اختيار التقنيات: إعطاء عمادة الكلية نظرة شاملة ولحظية على سير العملية الأكاديمية
- قواعد التسميات المعتمدة: DashboardView, MetricCard, AttendanceTrendChart
