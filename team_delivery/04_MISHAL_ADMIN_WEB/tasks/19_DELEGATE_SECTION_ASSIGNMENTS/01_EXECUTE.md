...
## المهمة: بناء تعيين المناديب للشعب (Delegate Section Assignments)
...
- المهمة الحالية: بناء تعيين المناديب للشعب (Delegate Section Assignments)
- الهدف الأساسي: تحديد المندوب المسؤول رسمياً عن استضافة كل شعبة دراسية
...
==================================================
- بناء شاشة ربط المندوب بالشعبة والتحقق من عدم تكرار مناديب متعددين للشعبة ذاتها
- البنية المطلوبة للملفات: admin_web/lib/features/delegate_assignments/ (delegate_assignments_view.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Mapping Tables & Modals
- مبرر اختيار التقنيات: حصر صلاحية بث الجلسة لمندوب الشعبة المعتمد فقط
- قواعد التسميات المعتمدة: DelegateAssignmentsView
