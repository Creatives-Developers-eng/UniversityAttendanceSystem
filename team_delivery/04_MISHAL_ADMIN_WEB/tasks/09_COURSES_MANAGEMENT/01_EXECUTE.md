...
## المهمة: بناء إدارة المقررات الدراسية (Courses Management)
...
- المهمة الحالية: بناء إدارة المقررات الدراسية (Courses Management)
- الهدف الأساسي: إدارة المواد الدراسية وربطها بالأقسام وتحديد ساعاتها المعتمدة وكود المادة
...
==================================================
- بناء جدول المقررات، فلترة حسب القسم والفصل، ونماذج الإضافة والتعديل
- البنية المطلوبة للملفات: admin_web/lib/features/courses/ (courses_list_view.dart, course_form_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Searchable DataTables, Course Code Formatter
- مبرر اختيار التقنيات: توفير دليل شامل لجميع المواد الدراسية في الكلية
- قواعد التسميات المعتمدة: CoursesListView, CourseFormDialog
