...
## المهمة: بناء إدارة تسجيل الطلاب بالشعب (Enrollments Management)
...
- المهمة الحالية: بناء إدارة تسجيل الطلاب بالشعب (Enrollments Management)
- الهدف الأساسي: توزيع وتسجيل الطلاب في الشعب الدراسية ومنع التكرار ونقل الطلاب بين الشعب
...
==================================================
- بناء واجهة تسجيل الطلاب الفردي والجماعي في الشعب وعرض كشوفات الشعب
- البنية المطلوبة للملفات: admin_web/lib/features/enrollments/ (enrollments_view.dart, batch_enroll_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Dual List Selector, Enrollment Tables
- مبرر اختيار التقنيات: ربط الطالب بالشعبة الرسمية التي يحق له تسجيل الحضور فيها
- قواعد التسميات المعتمدة: EnrollmentsView, BatchEnrollDialog
