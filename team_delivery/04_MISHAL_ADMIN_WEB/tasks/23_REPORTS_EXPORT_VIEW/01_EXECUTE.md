...
## المهمة: بناء استخراج وتصدير التقارير الإحصائية (Reports & Export View)
...
- المهمة الحالية: بناء استخراج وتصدير التقارير الإحصائية (Reports & Export View)
- الهدف الأساسي: استخراج كشوفات الغياب ونسب الحرمان وتقارير الحضور الدورية بصيغ PDF و Excel
...
==================================================
- بناء شاشة التقارير واختيار نوع التقرير (مادة، شعبة، قسم، طالب) ومعاينة وتصدير الملفات
- البنية المطلوبة للملفات: admin_web/lib/features/reports/ (reports_view.dart, report_preview_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: pdf/excel generation hooks, Download Trigger
- مبرر اختيار التقنيات: توفير المخرجات الورقية والرقمية الرسمية للجان الامتحانات والعمادة
- قواعد التسميات المعتمدة: ReportsView, ReportPreviewDialog
