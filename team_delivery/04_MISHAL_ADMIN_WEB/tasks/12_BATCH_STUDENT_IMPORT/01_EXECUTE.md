...
## المهمة: بناء استيراد الطلاب بالدفعات (Batch Student CSV/Excel Import)
...
- المهمة الحالية: بناء استيراد الطلاب بالدفعات (Batch Student CSV/Excel Import)
- الهدف الأساسي: رفع واستيراد كشوفات الطلاب عبر ملفات CSV/Excel ومعالجة الأخطاء والتحقق من التكرار
...
==================================================
- بناء واجهة رفع الملفات (Drag & Drop)، معاينة البيانات قبل الاستيراد، وتقرير النتائج
- البنية المطلوبة للملفات: admin_web/lib/features/students/import/ (student_import_view.dart, import_preview_table.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: FilePicker, Excel/CSV Parsers, Validation Stepper
- مبرر اختيار التقنيات: توفير الوقت الهائل عند بداية كل عام دراسي في تسجيل دفعات الطلاب
- قواعد التسميات المعتمدة: StudentImportView, ImportValidationSummary
