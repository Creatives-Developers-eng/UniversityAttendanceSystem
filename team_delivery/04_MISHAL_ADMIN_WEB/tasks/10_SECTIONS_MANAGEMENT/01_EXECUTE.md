...
## المهمة: بناء إدارة الشعب الدراسية (Sections Management)
...
- المهمة الحالية: بناء إدارة الشعب الدراسية (Sections Management)
- الهدف الأساسي: إدارة الشعب النظرية والعملية وربطها بالمواد الدراسية وتحديد القاعات والطاقة الاستيعابية
...
==================================================
- بناء واجهات الشعب وتصنيفها (نظري / عملي) وعرض أعداد الطلاب المسجلين
- البنية المطلوبة للملفات: admin_web/lib/features/sections/ (sections_list_view.dart, section_form_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Badges, Capacity Indicators, Filter Bars
- مبرر اختيار التقنيات: تنظيم تقسيم الطلاب إلى شعب دراسية ومجموعات معامل
- قواعد التسميات المعتمدة: SectionsListView, SectionFormDialog
