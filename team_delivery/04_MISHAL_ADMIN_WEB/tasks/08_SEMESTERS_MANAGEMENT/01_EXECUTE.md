...
## المهمة: بناء إدارة الفصول الدراسية (Semesters Management)
...
- المهمة الحالية: بناء إدارة الفصول الدراسية (Semesters Management)
- الهدف الأساسي: إدارة الفصول (أول، ثاني، صيفي) وربطها بالسنوات وتحديد الفصل النشط حالياً
...
==================================================
- بناء واجهات استعراض الفصول وإضافتها وتعديل حالتها والتحقق من التواريخ
- البنية المطلوبة للملفات: admin_web/lib/features/semesters/ (semesters_view.dart, semester_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Custom Dropdowns, Date Range Pickers
- مبرر اختيار التقنيات: فصل المقررات والجلسات حسب الفصول الدراسية المعتمدة
- قواعد التسميات المعتمدة: SemestersView, SemesterDialog
