...
## المهمة: بناء عميل REST API المخصص للويب (Web REST API Client)
...
- المهمة الحالية: بناء عميل REST API المخصص للويب (Web REST API Client)
- الهدف الأساسي: بناء عميل الاتصال بـ Backend وتضمين توكن Bearer في الترويسات ومعالجة CORS والأخطاء
...
==================================================
- بناء WebApiClient مع معالجة أخطاء الشبكة والـ 401 Unauthorized وإعادة التوجيه لتسجيل الدخول
- البنية المطلوبة للملفات: admin_web/lib/core/api/ (web_api_client.dart, api_endpoints.dart, web_auth_interceptor.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Dio for Web, Browser Http Adapter
- مبرر اختيار التقنيات: إدارة متطورة لطلبات الـ REST API في بيئة الويب
- قواعد التسميات المعتمدة: WebApiClient, ApiEndpoints
