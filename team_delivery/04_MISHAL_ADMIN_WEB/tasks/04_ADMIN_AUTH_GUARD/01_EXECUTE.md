...
## المهمة: بناء شاشات تسجيل دخول المشرف والتحقق (Admin Auth & Session Guard)
...
- المهمة الحالية: بناء شاشات تسجيل دخول المشرف والتحقق (Admin Auth & Session Guard)
- الهدف الأساسي: بناء شاشة تسجيل الدخول الإداري وحفظ جلسة المشرف في الـ SessionStorage بأمان
...
==================================================
- بناء نموذج تسجيل الدخول، حقول التحقق، حفظ JWT Token، وحماية الخروج التلقائي
- البنية المطلوبة للملفات: admin_web/lib/features/auth/ (admin_login_view.dart, auth_controller.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Flutter Form Validation, Web Secure Session
- مبرر اختيار التقنيات: حماية لوحة التحكم ومنع الوصول غير المصرح به
- قواعد التسميات المعتمدة: AdminLoginView, AuthController
