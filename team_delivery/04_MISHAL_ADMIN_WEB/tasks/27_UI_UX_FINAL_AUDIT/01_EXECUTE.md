...
## المهمة: التدقيق النهائي لمطابقة نظام التصميم UI_UX_SYSTEM.md
...
- المهمة الحالية: التدقيق النهائي لمطابقة نظام التصميم UI_UX_SYSTEM.md
- الهدف الأساسي: التحقق الشامل من دعم RTL والتوافق التام مع الشاشات الكبيرة وغياب الـ Emojis وتوفر الحالات الخمس
...
==================================================
- مراجعة كافة الشاشات الـ 25 بالويب وتطبيق معايير UI_UX_SYSTEM.md بدقة متناهية
- البنية المطلوبة للملفات: admin_web/lib/ (All UI files)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Responsive UI Verification, Arabic RTL Auditing
- مبرر اختيار التقنيات: تقديم لوحة تحكم إدارية راقية ومبهرة تليق بالصرح الجامعي
- قواعد التسميات المعتمدة: AdminWebUIUXAuditReport
