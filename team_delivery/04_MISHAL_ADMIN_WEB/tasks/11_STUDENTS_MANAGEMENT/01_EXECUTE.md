...
## المهمة: بناء إدارة حسابات الطلاب (Students Management CRUD)
...
- المهمة الحالية: بناء إدارة حسابات الطلاب (Students Management CRUD)
- الهدف الأساسي: استعراض والبحث وتعديل حسابات الطلاب وتفعيلها وإعادة تعيين الأجهزة المرتبطة
...
==================================================
- بناء جدول الطلاب مع شريط بحث متقدم وتصفية حسب القسم والمستوى وحالة الحساب
- البنية المطلوبة للملفات: admin_web/lib/features/students/ (students_list_view.dart, student_details_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Server-side Pagination, Advanced Filters
- مبرر اختيار التقنيات: إدارة شاملة لآلاف الطلاب بسهولة وسرعة فائقة
- قواعد التسميات المعتمدة: StudentsListView, StudentDetailsDialog
