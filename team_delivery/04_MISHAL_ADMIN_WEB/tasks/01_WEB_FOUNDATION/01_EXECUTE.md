...
## المهمة: تأسيس هيكل تطبيق الويب والثيمات (Web Foundation & Responsive Layout)
...
- المهمة الحالية: تأسيس هيكل تطبيق الويب والثيمات (Web Foundation & Responsive Layout)
- الهدف الأساسي: إنشاء الهيكل العام للويب مع الشريط الجانبي والسمات المتجاوبة ودعم RTL ونظام الألوان M3
...
==================================================
- إنشاء main.dart وإعداد الـ Scaffold العام مع NavigationRail والشريط العلوي والسمات
- البنية المطلوبة للملفات: admin_web/lib/app/ (app.dart, theme.dart, responsive_layout.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Flutter Web, Material 3, Responsive Framework
- مبرر اختيار التقنيات: توفير لوحة تحكم سريعة ومتجاوبة تماماً مع مختلف أحجام شاشات الويب
- قواعد التسميات المعتمدة: AdminWebApp, AdminTheme, ResponsiveLayout
