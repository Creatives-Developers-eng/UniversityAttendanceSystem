...
## المهمة: بناء واجهة سجلات التدقيق والأمان (Audit Log View)
...
- المهمة الحالية: بناء واجهة سجلات التدقيق والأمان (Audit Log View)
- الهدف الأساسي: استعراض الأحداث الأمنية والتغييرات الحساسة وتسجيلات الدخول والتعديلات الإدارية
...
==================================================
- بناء جدول سجلات التدقيق مع إظهار المنفذ، نوع الحدث، التاريخ، و IP المتصل
- البنية المطلوبة للملفات: admin_web/lib/features/audit_logs/ (audit_log_view.dart, log_details_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Security Log Table, Severity Color Coding
- مبرر اختيار التقنيات: ضمان الشفافية والمساءلة وتتبع أي نشاط إداري أو أمني في النظام
- قواعد التسميات المعتمدة: AuditLogView, LogDetailsDialog
