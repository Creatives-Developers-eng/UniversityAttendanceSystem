...
## المهمة: بناء إدارة المناديب وتعيينهم (Delegates Management)
...
- المهمة الحالية: بناء إدارة المناديب وتعيينهم (Delegates Management)
- الهدف الأساسي: إدارة وتعيين مناديب الدفعات والشعب وتحديد صلاحيات فتح واستضافة الجلسات
...
==================================================
- بناء واجهات المناديب وتعيين طالب كمندوب لشعبة محددة وإلغاء التعيين
- البنية المطلوبة للملفات: admin_web/lib/features/delegates/ (delegates_view.dart, delegate_assign_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Selection Dialogs, Active Status Toggles
- مبرر اختيار التقنيات: التحكم الدقيق في من يملك صلاحية استضافة جلسات الحضور بالقاعات
- قواعد التسميات المعتمدة: DelegatesView, DelegateAssignDialog
