...
## المهمة: بناء المعمارية ومسارات التنقل للويب (Web Architecture & Navigation Routes)
...
- المهمة الحالية: بناء المعمارية ومسارات التنقل للويب (Web Architecture & Navigation Routes)
- الهدف الأساسي: بناء مسارات التوجيه للويب مع حماية المسارات (Route Guards) والتنقل السلس
...
==================================================
- بناء فئات التوجيه GoRouter / Flutter Router وإدارة الـ Breadcrumbs ومسارات الصفحات
- البنية المطلوبة للملفات: admin_web/lib/app/routes/ (web_routes.dart, route_guards.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: GoRouter / Flutter Navigator 2.0
- مبرر اختيار التقنيات: دعم الـ URLs المباشرة في المتصفح وزري الرجوع والتقدم وحماية المسارات
- قواعد التسميات المعتمدة: WebRoutes, AdminAuthGuard
