...
## المهمة: تدقيق الأداء والأمان للوحة الويب (Web Performance & Security Audit)
...
- المهمة الحالية: تدقيق الأداء والأمان للوحة الويب (Web Performance & Security Audit)
- الهدف الأساسي: فحص سرعة تحميل الجداول الكبيرة وحماية جلسات المشرفين والتأكد من خلو الكود من أي تسريب
...
==================================================
- إجراء فحص أمان للمتصفح، منع حفظ التوكن في LocalStorage غير المحمي، وضبط أداء الجداول
- البنية المطلوبة للملفات: admin_web/lib/ (Security & Performance audit)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Web Auditing & Lighthouse Metrics
- مبرر اختيار التقنيات: ضمان استجابة سريعة للوحة التحكم وحماية عالية لبيانات الكلية
- قواعد التسميات المعتمدة: AdminWebSecurityAuditReport
