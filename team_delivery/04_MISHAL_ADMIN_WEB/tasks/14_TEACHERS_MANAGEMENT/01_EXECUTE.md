...
## المهمة: بناء إدارة الكادر التدريسي (Teachers Management)
...
- المهمة الحالية: بناء إدارة الكادر التدريسي (Teachers Management)
- الهدف الأساسي: إدارة حسابات الأساتذة وتصنيفهم (عملي / نظري) وتعيين الأقسام التابعين لها
...
==================================================
- بناء جدول الأساتذة ونماذج الإضافة وتعديل الصلاحيات وبيانات الاتصال
- البنية المطلوبة للملفات: admin_web/lib/features/teachers/ (teachers_list_view.dart, teacher_form_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: DataTables, Role Badges
- مبرر اختيار التقنيات: تنظيم قاعدة بيانات أعضاء هيئة التدريس والمساعدين
- قواعد التسميات المعتمدة: TeachersListView, TeacherFormDialog
