...
## المهمة: بناء واجهة إدارة الصلاحيات والأدوار (Permissions & Roles UI)
...
- المهمة الحالية: بناء واجهة إدارة الصلاحيات والأدوار (Permissions & Roles UI)
- الهدف الأساسي: استعراض صلاحيات الأدوار الرسمية في النظام (ADMIN, TEACHER, DELEGATE, STUDENT)
...
==================================================
- بناء مصفوفة الصلاحيات واستعراض صلاحيات كل دور على مستوى الـ Endpoints والعمليات
- البنية المطلوبة للملفات: admin_web/lib/features/permissions/ (roles_permissions_view.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Permission Matrix Grid
- مبرر اختيار التقنيات: توثيق وتوضيح حدود وصلاحيات كل فئة مستخدم في الكلية
- قواعد التسميات المعتمدة: RolesPermissionsView
