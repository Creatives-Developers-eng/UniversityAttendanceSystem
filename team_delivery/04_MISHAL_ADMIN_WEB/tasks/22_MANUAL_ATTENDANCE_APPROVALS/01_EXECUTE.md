...
## المهمة: بناء واجهة اعتماد التحضير اليدوي (Manual Attendance Approvals View)
...
- المهمة الحالية: بناء واجهة اعتماد التحضير اليدوي (Manual Attendance Approvals View)
- الهدف الأساسي: مراجعة واعتماد أو رفض طلبات الاستثناء والتحضير اليدوي المرفوعة من الأساتذة
...
==================================================
- بناء واجهة استعراض الطلبات المعلقة وزري الاعتماد والرفض مع إدخال المبرر
- البنية المطلوبة للملفات: admin_web/lib/features/manual_attendance/ (manual_approvals_view.dart, approval_action_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Approval Workflow UI, Reason Dialogs
- مبرر اختيار التقنيات: حوكمة الاستثناءات الأكاديمية ومنع التلاعب بسجلات الحضور
- قواعد التسميات المعتمدة: ManualApprovalsView, ApprovalActionDialog
