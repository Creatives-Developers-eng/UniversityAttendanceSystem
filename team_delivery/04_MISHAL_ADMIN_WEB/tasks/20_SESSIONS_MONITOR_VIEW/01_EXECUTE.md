...
## المهمة: بناء واجهة مراقبة واستعراض الجلسات (Sessions Monitor View)
...
- المهمة الحالية: بناء واجهة مراقبة واستعراض الجلسات (Sessions Monitor View)
- الهدف الأساسي: مراقبة الجلسات المفتوحة والمكتملة وحالة المزامنة وعدد الحاضرين في كل جلسة
...
==================================================
- بناء شاشة مراقبة الجلسات الحية وفلترة الجلسات حسب المادة والمندوب والتاريخ
- البنية المطلوبة للملفات: admin_web/lib/features/sessions_view/ (sessions_monitor_view.dart, session_details_modal.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Live Polling / Status Indicators
- مبرر اختيار التقنيات: متابعة لحظية لسير الجلسات في كافة قاعات الكلية
- قواعد التسميات المعتمدة: SessionsMonitorView, SessionDetailsModal
