...
## المهمة: بناء إدارة تكليفات الأساتذة (Teacher Section Assignments)
...
- المهمة الحالية: بناء إدارة تكليفات الأساتذة (Teacher Section Assignments)
- الهدف الأساسي: إسناد المواد والشعب للأساتذة المشرفين وتحديد نوع التكليف (نظري / عملي)
...
==================================================
- بناء جدول التكليفات ونوافذ إسناد الشعب للمدرسين ومتابعة نصاب كل أستاذ
- البنية المطلوبة للملفات: admin_web/lib/features/teacher_assignments/ (teacher_assignments_view.dart, assign_teacher_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Assignment Matrix Grid
- مبرر اختيار التقنيات: تحديد مسؤولية كل أستاذ عن المواد والشعب التي يدرسها
- قواعد التسميات المعتمدة: TeacherAssignmentsView, AssignTeacherDialog
