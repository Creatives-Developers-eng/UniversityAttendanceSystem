...
## المهمة: بناء واجهة استعراض سجلات الحضور (Attendance Records View)
...
- المهمة الحالية: بناء واجهة استعراض سجلات الحضور (Attendance Records View)
- الهدف الأساسي: استعراض وتصفية سجلات حضور الطلاب لكل مادة وشعبة وتاريخ وحالة الحضور
...
==================================================
- بناء جدول سجلات الحضور مع إمكانية البحث باسم الطالب والفلترة المتقدمة
- البنية المطلوبة للملفات: admin_web/lib/features/attendance_view/ (attendance_records_view.dart, attendance_filter_bar.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Filterable Records Grid, Attendance Status Chips
- مبرر اختيار التقنيات: استعراض دقيق لسجل كل طالب مع توثيق طريقة التحضير والطابع الزمني
- قواعد التسميات المعتمدة: AttendanceRecordsView, AttendanceFilterBar
