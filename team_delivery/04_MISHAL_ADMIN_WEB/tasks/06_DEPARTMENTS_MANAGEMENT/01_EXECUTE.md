...
## المهمة: بناء إدارة الأقسام الأكاديمية (Departments Management CRUD)
...
- المهمة الحالية: بناء إدارة الأقسام الأكاديمية (Departments Management CRUD)
- الهدف الأساسي: جداول ونماذج إضافة واستعراض وتعديل وتفعيل الأقسام العلمية بالكلية
...
==================================================
- بناء شاشات قائمة الأقسام، نافذة إضافة/تعديل قسم، والربط بنقاط الـ API الرسمية
- البنية المطلوبة للملفات: admin_web/lib/features/departments/ (departments_list_view.dart, department_form_dialog.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: PaginatedDataTable, Form Validators
- مبرر اختيار التقنيات: إدارة الهيكل التنظيمي الأساسي للأقسام الأكاديمية
- قواعد التسميات المعتمدة: DepartmentsListView, DepartmentFormDialog
