# دليل التشغيل والتسليم الرسمي الشامل | مشعل الحاج (04_MISHAL_ADMIN_WEB)
...
2. مجلد حقيبة التسليم والتشغيل الخاصة بك: `team_delivery/04_MISHAL_ADMIN_WEB/`.
3. مجلد العمل المسموح لك بالتطوير فيه: `admin_web/`.
...
- **المجلد المصرح لك بالتعديل فيه:** `admin_web/`
