...
## المهمة: ربط التحقق بسياق هوية الطالب (Student Verification Context)
...
- المهمة الحالية: ربط التحقق بسياق هوية الطالب (Student Verification Context)
- الهدف الأساسي: تنفيذ دالة verifyStudent والتحقق من هوية الطالب المتقدم لجلسة الحضور
...
==================================================
- ربط المعرف الجامعي للطالب بالقالب الحيوي وإرجاع تقرير التحقق الموثق
- البنية المطلوبة للملفات: mobile_app/lib/biometric/services/ (student_biometric_service.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Contextual Service Orchestration
- مبرر اختيار التقنيات: إتاحة استدعاء نظيف ومباشر من قبل تطبيق الطالب
- قواعد التسميات المعتمدة: StudentBiometricService, StudentVerificationRequest
