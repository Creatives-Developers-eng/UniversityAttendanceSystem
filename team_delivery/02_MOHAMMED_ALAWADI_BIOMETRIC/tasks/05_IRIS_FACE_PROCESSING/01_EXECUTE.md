...
## المهمة: معالجة واستخراج معالم بصمة العين/الوجه (Iris & Face Landmark Extraction)
...
- المهمة الحالية: معالجة واستخراج معالم بصمة العين/الوجه (Iris & Face Landmark Extraction)
- الهدف الأساسي: استخراج متجهات الميزات الهندسية للعين وملامح الوجه من الإطار المعتمد
...
==================================================
- بناء فئة LandmarkExtractor واستخراج متجهات الإحداثيات والخصائص الفريدة
- البنية المطلوبة للملفات: mobile_app/lib/biometric/processing/ (landmark_extractor.dart, feature_vector.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Landmark Detection Algorithms, Normalized Vector Math
- مبرر اختيار التقنيات: تحويل الصورة إلى متجه ميزات رقمي خفيف وثابت هندسياً
- قواعد التسميات المعتمدة: LandmarkExtractor, FeatureVector
