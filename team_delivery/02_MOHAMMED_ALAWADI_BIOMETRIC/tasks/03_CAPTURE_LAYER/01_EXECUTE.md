...
## المهمة: بناء طبقة التقاط الصورة الحيوية (Biometric Capture Layer)
...
- المهمة الحالية: بناء طبقة التقاط الصورة الحيوية (Biometric Capture Layer)
- الهدف الأساسي: إدارة الكاميرا والتقاط إطارات صورة الوجه والعين بدقة معيارية مناسبة
...
==================================================
- بناء فئة CameraCaptureController وضبط أبعاد الصورة (Resolution) وزاوية الرؤية
- البنية المطلوبة للملفات: mobile_app/lib/biometric/capture/ (camera_capture_controller.dart, frame_buffer.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Camera Plugin / Native Capture Streams
- مبرر اختيار التقنيات: التقاط إطارات مستمرة سريعة مع استهلاك منخفض للموارد
- قواعد التسميات المعتمدة: CameraCaptureController, BiometricFrame
