...
## المهمة: تصميم وتأسيس خدمة التحقق الحيوي (BiometricService Interface)
...
- المهمة الحالية: تصميم وتأسيس خدمة التحقق الحيوي (BiometricService Interface)
- الهدف الأساسي: بناء الواجهة المجردة وعزل محرك البصمة الحيوية عن الواجهات الرسومية
...
==================================================
- إنشاء واجهة BiometricService وتحديد توقيعات دوال الالتقاط والمعالجة والمقارنة
- البنية المطلوبة للملفات: mobile_app/lib/biometric/interfaces/ (biometric_service.dart, biometric_types.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Dart Abstract Classes, Enums, Immutable Value Objects
- مبرر اختيار التقنيات: فصل تام بين المحرك الداخلي وتطبيقات الواجهات لتمكين الترقية المستقلة
- قواعد التسميات المعتمدة: BiometricService, BiometricVerificationResult
