...
## المهمة: بناء فحص جودة الصورة والإضاءة (Quality & Liveness Check)
...
- المهمة الحالية: بناء فحص جودة الصورة والإضاءة (Quality & Liveness Check)
- الهدف الأساسي: التأكد من وضوح الصورة وتوازن الإضاءة والتحقق من الحيوية لمنع الصور المطبوعة
...
==================================================
- بناء خوارزمية قياس حدة الصورة (Sharpness) ومستوى الإضاءة واكتشاف الوجه
- البنية المطلوبة للملفات: mobile_app/lib/biometric/quality/ (quality_checker.dart, liveness_detector.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Image Processing, Contrast & Blur Metrics
- مبرر اختيار التقنيات: استبعاد الصور غير الصالحة فورياً قبل مرحلة استخراج المعالم المكلفة
- قواعد التسميات المعتمدة: QualityChecker, QualityScore, LivenessResult
