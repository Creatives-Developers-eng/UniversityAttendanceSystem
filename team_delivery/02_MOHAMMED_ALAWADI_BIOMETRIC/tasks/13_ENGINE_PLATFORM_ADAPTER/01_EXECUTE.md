...
## المهمة: بناء محول المحرك والمنصة (Engine Platform Adapter)
...
- المهمة الحالية: بناء محول المحرك والمنصة (Engine Platform Adapter)
- الهدف الأساسي: بناء قنوات الاتصال الأصيلة مع المنصة Platform Channels إن لزم استخدام مكتبات C++/Native
...
==================================================
- بناء فئة NativeBiometricAdapter وتجهيز الـ MethodChannels للربط الأصيل
- البنية المطلوبة للملفات: mobile_app/lib/biometric/adapter/ (native_biometric_adapter.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Flutter MethodChannel / FFI / Pure Dart Fallback
- مبرر اختيار التقنيات: تمكين استخدام مكتبات المعالجة السريعة على نظام Android/iOS بسلاسة
- قواعد التسميات المعتمدة: NativeBiometricAdapter, PlatformChannelBridge
