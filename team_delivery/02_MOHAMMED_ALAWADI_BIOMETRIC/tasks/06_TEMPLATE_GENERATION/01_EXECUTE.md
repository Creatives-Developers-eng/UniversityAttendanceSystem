...
## المهمة: توليد القالب الحيوي المشفر (Biometric Template Generation)
...
- المهمة الحالية: توليد القالب الحيوي المشفر (Biometric Template Generation)
- الهدف الأساسي: تشفير متجهات الميزات في قوالب بيومترية آمنة غير قابلة للعكس (Irreversible Templates)
...
==================================================
- بناء فئة TemplateGenerator وتطبيق التشفير والـ Hashing الآمن للميزات
- البنية المطلوبة للملفات: mobile_app/lib/biometric/templates/ (template_generator.dart, biometric_template.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Crypto (AES/HMAC/SHA-256), Binary Serialization
- مبرر اختيار التقنيات: حماية خصوصية الطالب ومنع استرجاع الصورة الأصلية من القالب المشفر
- قواعد التسميات المعتمدة: TemplateGenerator, BiometricTemplate
