...
## المهمة: بناء مستودع القوالب الحيوية الآمن (Secure Template Repository)
...
- المهمة الحالية: بناء مستودع القوالب الحيوية الآمن (Secure Template Repository)
- الهدف الأساسي: تخزين وإدارة القوالب المشفرة للطلاب محلياً والوصول الآمن لها عبر معرف الطالب
...
==================================================
- بناء مستودع LocalTemplateRepository مع تشفير الملفات وقفل الوصول
- البنية المطلوبة للملفات: mobile_app/lib/biometric/repository/ (template_repository.dart, secure_template_store.dart)

==================================================
5. التقنيات وقواعد التسميات والمعايير (STANDARDS)
==================================================
- التقنيات المستخدمة: Secure File I/O, Key Management
- مبرر اختيار التقنيات: توفير وصول فوري للقالب المخزن أثناء جلسة الحضور دون الحاجة للإنترنت
- قواعد التسميات المعتمدة: ITemplateRepository, LocalTemplateRepository
