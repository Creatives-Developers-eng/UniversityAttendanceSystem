# المرحلة 06: بناء عميل REST API المخصص للويب (Web API Client & Interceptors)
## نظام الحضور الجامعي الذكي (University Attendance System) — 04 مشعل الحاج

---

### 1. الهدف من المرحلة (GOAL)
تنفيذ وتحقيق مستهدفات: **المرحلة 06: بناء عميل REST API المخصص للويب (Web API Client & Interceptors)** بدقة ونظافة برمجية كاملة.
