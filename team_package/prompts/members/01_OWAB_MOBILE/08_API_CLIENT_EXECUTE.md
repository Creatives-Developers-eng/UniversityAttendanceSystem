# المرحلة 08: بناء عميل الـ API والـ Interceptors لـ REST API
## نظام الحضور الجامعي الذكي (University Attendance System) — 01 أواب النزيلي

---

### 1. الهدف من المرحلة (GOAL)
تنفيذ وتحقيق مستهدفات: **المرحلة 08: بناء عميل الـ API والـ Interceptors لـ REST API** بدقة ونظافة برمجية كاملة.
