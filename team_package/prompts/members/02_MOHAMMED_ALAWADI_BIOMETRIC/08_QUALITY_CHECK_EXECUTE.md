# المرحلة 08: بناء فحص جودة الصورة والإضاءة (Quality & Liveness Check)
## نظام الحضور الجامعي الذكي (University Attendance System) — 02 محمد العواضي

---

### 1. الهدف من المرحلة (GOAL)
تنفيذ وتحقيق مستهدفات: **المرحلة 08: بناء فحص جودة الصورة والإضاءة (Quality & Liveness Check)** بدقة ونظافة برمجية كاملة.
