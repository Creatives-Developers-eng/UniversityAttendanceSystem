# المرحلة 10: معالجة واستخراج معالم بصمة العين/الوجه (Iris/Face Processing)
## نظام الحضور الجامعي الذكي (University Attendance System) — 02 محمد العواضي

---

### 1. الهدف من المرحلة (GOAL)
تنفيذ وتحقيق مستهدفات: **المرحلة 10: معالجة واستخراج معالم بصمة العين/الوجه (Iris/Face Processing)** بدقة ونظافة برمجية كاملة.
