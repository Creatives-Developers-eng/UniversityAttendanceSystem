# المرحلة 02: إدارة الشبكة المحلية واستخراج IP (Local Network Manager)
## نظام الحضور الجامعي الذكي (University Attendance System) — 03 محمد العيدروس

---

### 1. الهدف من المرحلة (GOAL)
تنفيذ وتحقيق مستهدفات: **المرحلة 02: إدارة الشبكة المحلية واستخراج IP (Local Network Manager)** بدقة ونظافة برمجية كاملة.
