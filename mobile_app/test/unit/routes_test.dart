...
void main() {
  group('AppRoutes Verification', () {
    test('Route constants are defined properly', () {
      ...
      expect(AppRoutes.theoryReports, '/theoretical-teacher/reports');
    });
    ...
    test('onGenerateRoute produces valid routes for defined paths', () {
      ...
      final theoreticalRoute = AppRoutes.onGenerateRoute(const RouteSettings(name: AppRoutes.theoreticalTeacherDashboard));
      expect(theoreticalRoute, isA<MaterialPageRoute>());

      final theoryReportsRoute = AppRoutes.onGenerateRoute(const RouteSettings(name: AppRoutes.theoryReports));
      expect(theoryReportsRoute, isA<MaterialPageRoute>());
